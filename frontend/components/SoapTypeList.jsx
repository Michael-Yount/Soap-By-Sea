        ...
        <div className="p-8">
          ...
          <div className="flex flex-wrap md:justify-center -m-2">
            <div className="w-full md:w-auto p-2 my-6">
              <Link
                className="block w-full px-12 py-3.5 text-lg text-center text-black font-bold bg-blue-400 hover:bg-blue-800 hover:text-white focus:ring-4 focus:ring-gray-600 rounded-full"
